              ...
              <TooltipTrigger asChild>
                ...
                >
                  <Button
                    variant="ghost"
                    size="icon"
                    className="rounded-full bg-primary/30 hover:bg-primary/40 text-primary dark:bg-primary/40 dark:hover:bg-primary/50 dark:text-primary-foreground shadow-md hover:shadow-lg transition-all duration-300"
                    onClick={() => {
                      // Open the dialog in TrustedContactsPage instead of adding directly
                      window.dispatchEvent(
                        new CustomEvent("openAddContactDialog"),
                      );
                    }}
                  >
                    <UserPlus size={18} />
