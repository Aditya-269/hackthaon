        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="techniques" className="p-6">
            ...
            <div className="mt-8 text-center">
              <Button className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white px-8">
                View All Techniques
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <Card className="bg-white/50 dark:bg-gray-800/30 shadow-xl border border-gray-100/20 dark:border-gray-700/20 rounded-3xl overflow-hidden backdrop-blur-md">
          ...
          <CardContent>
            ...
            <Button className="w-full mt-4 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white">
              Join Our Community
            </Button>
          </CardContent>
        </Card>
